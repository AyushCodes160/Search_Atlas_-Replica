...
const PAGES = [
  {
    ...
    status: "Live",
    title: "Site Audit",
    body: "Lighthouse + Llama 3.3 fix plan + share link + PDF export.",
    tilt: -3,
    tint: "bg-paper-100",
  },
  {
    n: "02",
    status: "Live",
    title: "Whole-Site Audit",
    body: "Auto-crawl every page. Fast + deep modes. Site-wide health score.",
    tilt: 2,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "Keywords",
    body: "Google Autocomplete + Llama clustering. 200+ keyword ideas.",
    tilt: -2,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "OTTO SEO",
    body: "Auto-apply metadata fixes via JS injection script.",
    tilt: 3,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "Rank Tracker",
    body: "SerpAPI positions + Groq volume/CPC estimates.",
    tilt: -1,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "Smart Ads",
    body: "AI ad copy for Google, Meta, LinkedIn. 3 A/B variants.",
    tilt: 2,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "Backlinks",
    body: "AI backlink profile + anchor text + competitor gap analysis.",
    tilt: -2,
    tint: "bg-paper-100",
  },
  {
    ...
    status: "Live",
    title: "Reports",
    body: "Aggregate all data into branded PDF reports with AI summary.",
    tilt: 1,
    tint: "bg-paper-100",
  },
];
